        ...
        <header className="mb-6 flex items-start justify-between gap-4 border-b border-slate-800 pb-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="rounded-xl border border-slate-700 bg-slate-900 px-4 py-2 text-sm font-medium text-slate-200 hover:bg-slate-800 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
        ...
        {!loading && !error && !dashboard?.noData ? (
          <>
            ...
            {pollingError && !loading ? (
              <div className="mb-4 rounded-2xl border border-rose-700/40 bg-rose-900/10 p-4 text-sm text-rose-200">
                ⚠️ {pollingError}
              </div>
            ) : null}
